...
dotnet restore "$DEPLOYMENT_SOURCE/billboard-app.csproj"
exitWithMessageOnError "dotnet restore failed"

# 2. Build and publish
dotnet publish "$DEPLOYMENT_SOURCE/billboard-app.csproj" --output "$DEPLOYMENT_TEMP" --configuration Release
